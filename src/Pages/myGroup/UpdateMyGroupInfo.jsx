...
const UpdateMyGroupInfo = () => {
    ...
    const handleSubmit = e => {
        ...
        fetch(`https://hobbe-hub-server.vercel.app/all-groups/${_id}`, {
            method: 'PUT',
            headers: {
        ...
        <div className="max-w-3xl mx-auto px-4 py-10">
            <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <form onSubmit={handleSubmit} className="grid gap-3">
                    ...
                    <input type="submit" value="Save" className="px-3 py-1 bg-blue-600 text-white rounded" />

                    <Link to="/my-groups">
                        <input type="button" value="Cancel" className="px-3 py-1 bg-gray-400 text-white rounded" />
                    </Link>
                </form>
            </div>
        </div>
